...
export function deserialize(Model, dependencies, serializedString, options=SERIALIZE_OPTIONS) {
    ...
    if(options.format === SERIALIZE_FORMAT_JSON) {
        const serializedValue = JSON.parse(serializedString)
        return Model.createPrimalState(dependencies, serializedValue, options)
    }
        ...
        for(const name of this.constructor.initOrder) {
            ...
            if(this.constructor.childrenExternalDependencies.has(name)) {
                ...
                if(this[OLD_STATE] === null && !this._value.has(name)) {
                    ...
                    const immutable = Model.createPrimalState(childDependencies, ...getSerialized(name));
                ...
                if(this[OLD_STATE] === null && !this._value.has(name)) {
                    ...
                    const immutable = KeyValueModel.createPrimalState(null, ...getSerialized(name));
    ...
    metamorphose(dependencies={}) {
        ...
        if(this[_PRIMARY_SERIALIZED_VALUE]) {
            ...
            for(const serializedValue of serializedValues) {
                const childItem = this.constructor.Model.createPrimalState(
        ...
        if(this._value === null // only in primal state creation
            ...
            Object.defineProperty(this, '_value', {
                value: this.WrappedType
                            ? this.WrappedType.createPrimalState(childDependencies, ...(this[_PRIMARY_SERIALIZED_VALUE] || []))
                            : null
              , configureable: true
            });
        }
