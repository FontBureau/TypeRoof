...
export function deserializeGen(Model, dependencies, serializedString, options=SERIALIZE_OPTIONS) {
    let serializedValue;
...
export async function deserialize(asyncResolve, Model, dependencies, serializedString, options=SERIALIZE_OPTIONS) {
    const gen =  deserializeGen(Model, dependencies, serializedString, options=SERIALIZE_OPTIONS);
