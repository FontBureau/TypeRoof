...
describe('createFontObject (LiberationMono-Regular.ttf: non-variable)', () => {
    // A truly static system font (no fvar). MaterialSymbolsOutlinedSubset
    // can NOT be used here: it has fvar+gvar (FILL/GRAD/wght/opsz axes).
    const LIBERATION_MONO_TTF = '/usr/share/fonts/truetype/LiberationMono-Regular.ttf'
