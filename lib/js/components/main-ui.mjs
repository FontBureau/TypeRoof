...
import * as TypeSpecDocs from './layouts/type-spec-docs.typeroof.jsx';
import * as TypeToolsGrid from './layouts/type-tools-grid.mjs';
import * as ExampleReactLayout from './dev-layouts/example-react.mjs';
import * as ProsemirrorTesting from './dev-layouts/prosemirror-testing.mjs';
...
export const Layouts = Object.freeze([
  ...
  , ['ProsemirrorTesting', 'Prosemirror – Testing', ProsemirrorTesting, LAYOUT_GROUP_DEVELOPMENT]
  , ['TypeSpecRamp', 'TypeSpec – Ramp', TypeSpecRamp, LAYOUT_GROUP_TYPE_TOOLS]
  , ['TypeSpecDocs', 'TypeSpec – Documents', TypeSpecDocs, LAYOUT_GROUP_DEFAULT]
]);
