...
import * as TypeSpecRamp from './layouts/ramp/index.typeroof.jsx';
import * as SimpleRamp from './layouts/simple-ramp/index.typeroof.jsx';
...
export const Layouts = Object.freeze([
  ...
  , ['SimpleRamp', 'Simple Ramp', SimpleRamp, LAYOUT_GROUP_TYPE_TOOLS]
]);
