...
export class Collapsible extends _BaseComponent {
    ...
    constructor(widgetBus, togglerLabel, contentsElement, isOpened = false) {
        const initialClasses = [Collapsible.BASE_CLASS, isOpened ? Collapsible.OPENED_CLASS : Collapsible.CLOSED_CLASS];
        const element = widgetBus.domTool.createElement('div', {class: initialClasses.join(' ')});
        const togglerElement = widgetBus.domTool.createElement('div', {class: `${Collapsible.BASE_CLASS}-toggler`, role: 'button', 'aria-expanded': isOpened});
