...
export class MoveItemsInListButton extends _BaseComponent {
    ...
    static setings = {
        [this.BACKWARD]: {
          ...
          , classToken: 'backward'
          , label: new HTMLString('<span class="material-symbols-outlined">keyboard_double_arrow_left</span> move backward')
        }
      , [this.FORWARD]: {
           title: 'Move item(s) one position forward.'
         , classToken: 'forward'
         , label: new HTMLString('move forward <span class="material-symbols-outlined">keyboard_double_arrow_right</span>')
        }
    };
    // jshint ignore:end
