...
export class GenericSelect extends _BaseComponent {
    ...
    // jshint ignore:end
    constructor(widgetBus, baseClass, labelContent, optionGetLabel, allowNull=[], onChangeFn=null) {
        super(widgetBus);
        if(optionGetLabel)
...
export class DynamicTag extends _BaseComponent {
    constructor(widgetBus, tag, attr, formatter, initialContent='(initializing)') {
        super(widgetBus);
...
export class UINumberInput extends _BaseComponent {
    ...
    //jshint ignore:end
    constructor(widgetBus, label, unit, minMax={}) {
        super(widgetBus);
        this._minMax = minMax;
...
export class PlainCheckboxInput {
    // jshint ignore:start
        ...
        static TEMPLATE = `<div class="ui_checkbox ui_checkbox-">
