...
class _UIBaseListItem extends _BaseComponent {
    static ROOT_CLASS = `ui_base_list_item`;
    static BASE_CLASSES = [];
    ...
    static DRAGHANDLE_TEMPLATE = '<span class="drag_handle" draggable="true">✥</span>';

    constructor(widgetBus, eventHandlers=[], draggable=false) {
        super(widgetBus);

        console.log(`${this}`, this, '_UIBaseList.prototype:', _UIBaseList.prototype,
        '\n_UIBaseList.prototype._setClassesHelper:', _UIBaseList.prototype._setClassesHelper, '_UIBaseList', _UIBaseList);
...
export class _UIBaseList extends _BaseDynamicCollectionContainerComponent {
    ...
    constructor(widgetBus, _zones) {
        ...
        this.element = this._localZoneElement = localZoneElement;
    }
