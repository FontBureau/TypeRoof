...
export class _UIBaseList extends _BaseDynamicCollectionContainerComponent {
    ...
    get _zonesArgs() {
        return this.constructor.UIItem.REQUIRE_ZONES_ARGUMENT
            ? [this._zones]
            : []
            ;
    }
     ...
     * can be overridden.
     */
    _getItemArgs(rootPath, dropEventHandlers, draggable) {
        return [
                ...this._zonesArgs
    ...
    _createWrapper(rootPath) {
        const childWidgetBus = this._childrenWidgetBus
          ...
          , dropEventHandlers = [
            ...
            , args = this._getItemArgs(rootPath, dropEventHandlers, draggable)
          ;
