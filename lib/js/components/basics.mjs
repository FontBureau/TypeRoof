...
export class _BaseDynamicContainerComponent extends _CommonContainerComponent {
    ...
    get dependencies() {
        ...
        // for all _BaseDynamicContainerComponent.
    ...
    initialUpdate(rootState) {
        ...
        let compareResult = StateComparison.createInitial(rootState, this.dependencies);
        const requiresFullInitialUpdate = this._provisionWidgets(compareResult);
        if(requiresFullInitialUpdate.size)
            // otherwise compareResult is not updated at this point
            compareResult = StateComparison.createInitial(rootState, this.dependencies);
        this._update(compareResult, requiresFullInitialUpdate, true);
    }
}
