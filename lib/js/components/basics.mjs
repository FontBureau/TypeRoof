...
export class _BaseDynamicContainerComponent extends _CommonContainerComponent {
    constructor(parentAPI, zones, itemsCollectionName, itemEntryPath=[]) {
        // provision widgets dynamically!
        super(parentAPI, zones);
        Object.defineProperties(this, {
            _itemsCollectionName: {value: itemsCollectionName}
          , _itemEntryPath: {
    ...
    _provisionWidgets(compareResult) {
        const {LIST_NEW_ORDER, EQUALS, MOVED, NEW, CHANGED} = StateComparison.COMPARE_STATUSES
          ...
          , itemsPath = this.parentAPI.rootPath.append(this._itemsCollectionName)
          ;
