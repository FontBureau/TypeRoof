...
class ComponentWrapper {
    ...
    static getChangedMapFromCompareResult(fullDependencyMappings, protocolHandlers
                                , isInitialUpdate, compareResult, toLocal=true) {
        let modelChangedMap;
        try {
            ...
            throw new Error(`[${this.name}] Can't get changedMap, see cause.`, { cause: error });
        }
...
export class _UIBaseMap extends _BaseDynamicCollectionContainerComponent {
    ...
    constructor(widgetBus, _zones, eventHandlers, label=null, dragEntries=false) {
        const labelElement = label && widgetBus.domTool.createElement('span', {'class': 'typeroof-ui-label'}, label)
          , dragHandleElement = widgetBus.domTool.createElement('span', {'class':'drag_handle', draggable: 'true'}, new HTMLString('<span class="material-symbols-outlined">drag_pan</span>'))
        ...
        for(const [index, [key, /*axesLocationSet*/]] of gen) {
            ...
            if(!keyProtocolHandler.hasRegistered(keyId)) {
                ...
                if(this.DRAG_ENTRIES) {
                    dragHandleElement = this._domTool.createElement('span', {'class':'drag_handle', draggable: 'true'}, new HTMLString('<span class="material-symbols-outlined">drag_pan</span>'));
                    const dragHandlers = [
...
export const DRAGHANDLE_TEMPLATE = `<span class="drag_handle" draggable="true">
...
class _UIBaseListItem extends _BaseComponent {
    ...
    constructor(widgetBus, eventHandlers=[], draggable=false, label=null) {
        super(widgetBus);
