...
export class _BaseComponent {
    ...
    _changeState(fn) {
        return this.parentAPI.changeState(fn);
    }
    ...
    // wraps fn into a call to this.parentAPI.changeState,
...
class ComponentWrapper {
    ...
    constructor(parentAPI, rawDependencyMapping
        ...
        // FIXME/TODO: parentAPI should be renamed. It's more like the general
        ...
        for(const entry_ of dependencyMappings) {
            ...
            if(protocolHandler.length && this._protocolHandlers.has(protocolHandler)) {
                ...
                if(protocolHandlerImplementation.treatAdressAsRootPath) {
                    ...
                    // "animationProperties@{this.parentAPI.rootPath}
                    ...
                    const address = external.slice(protocolHandler.length)
                      ...
                      , absoluteAdress = path.isExplicitlyAbsolute
                            ...
                            : this.parentAPI.rootPath.append(...path).toString()
                      ;
    ...
    updateRootPath(rootPathArgument=null, relativeRootPath=null) {
        ...
        const absPath =  this._explicitAbsoluteRootPath === null
                ? this.parentAPI.grandParentAPI.rootPath // DEFAULT
        ...
        if(this.parentAPI.rootPath !== null && this.parentAPI.rootPath.equals(rootPath)) {
            // console.log(`${this.constructor.name}.updateRootPath nothing changed ${rootPath}`);
            return;
        }
        //const oldRootPath = this.parentAPI.rootPath;
...
export class _CommonContainerComponent extends _BaseComponent {
    ...
    _initWrapper(childrenParentAPI, settings, dependencyMappings, Constructor, ...args) {
        ...
        const widgetWrapper = new ComponentWrapper(childrenParentAPI, dependencyMappings
    ...
    updateRootPath() {
        ...
        //     if(widgetWrapper.parentAPI.rootPath.parts.length > this.parentAPI.rootPath.parts.length)
