...
describe("ClassesAndStylesManager", () => {
    it("applies and removes classes on the target element", () => {
        ...
        expect(targetElement.classList.contains("typeroof-layout--type-stage")).toBe(true);
        manager.removeClass("typeroof-layout--type-stage");
        expect(targetElement.classList.contains("typeroof-layout--type-stage")).toBe(false);
    });
