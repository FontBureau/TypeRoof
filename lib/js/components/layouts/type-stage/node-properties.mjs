...
import {
    horizontalLayoutConsumptionPolicyGen,
    blockMarginsConsumptionPolicyGen,
 ...
 */
/**
 * The node channel's inheritance policy: consumption rules for
 * geometry inputs/results that a scope must not re-propagate through
 * the parent layer (horizontalLayoutConsumptionPolicyGen,
 * blockMarginsConsumptionPolicyGen). Frozen to signal "not a draft".
 */
// NOTE: at some point this will have to become configuration, if
// more consumers of the node-properties with different setup emerge,
