...
describe("HierarchicalScopeNodeProperties root scope", () => {
    ...
    it("resolves percent-layout width/height against the environment", () => {
        ...
        // no layout/width here: the identity yields were removed —
        // the geometry generator owns layout/width (not in this
        // block's generator set).
        expect(props.get(`${LAYOUT}width`)).toBe(undefined);
    });
