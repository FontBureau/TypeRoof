// Document-nodes meta layer: renderer-independent document-tree
// infrastructure extracted from the viewer (Phase 5a, delegation
// landing — thoughts/plans/2026-09-05-2159-document-tree-walker-renderer-separation.md).
//
...
//
// Phase 5b will grow this module into the always-active
// `DocumentNodesMeta` widget tree that owns per-node nodeProperties;
// the pure derivations here are its foundation.
...
export function typeSpecStylerDependencyMappings(
    ...
    const dependencyMappings = [
        ...
        [`nodeProperties@${originTypeSpecPath.toString()}`, "nodeProperties@"],
        ["/font", "rootFont"],
    ];
