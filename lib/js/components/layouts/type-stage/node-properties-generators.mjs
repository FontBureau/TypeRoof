...
export function* horizontalLayoutNodePropertiesGen(inputCascade, hostContext) {
    ...
    const runionConfigIsComplete =
        algorithm === "HorizontalLayoutRunionModel" &&
        inputCascade.get(`${HORIZONTAL_LAYOUT}minLineLength`) !== undefined &&
        inputCascade.get(`${HORIZONTAL_LAYOUT}columnGutter`) !== undefined &&
        inputCascade.get(`${HORIZONTAL_LAYOUT}columns`) !== undefined &&
        inputCascade.get(`${HORIZONTAL_LAYOUT}columns`).size > 0;
