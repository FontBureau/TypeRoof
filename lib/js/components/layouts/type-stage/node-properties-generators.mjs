...
export function* horizontalLayoutNodePropertiesGen(
    ...
    // All computation is in synthetics; the cascade is not read in the
    // body (the contract requires the argument).
    void inputCascade;
    const args = [
    ...
    // (en and pt boundaries per the unit discipline).
