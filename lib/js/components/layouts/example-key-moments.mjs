...
class KeyMomentController extends _BaseContainerComponent {
    ...
    constructor(parentAPI, zones) {
        ...
        const widgets = [
          ...
          , [
              ...
              , this._getDefaults.bind(this, '', 'fontSize', 66)
    ...
    _getDefaults(prefix, key, defaultVal=super._NOTDEF) {
        // const axisPrefix = 'axesLocations/';
...
export class KeyMomentsController extends _BaseDynamicCollectionContainerComponent {
    constructor(parentAPI, zones, itemEntryPath, ChildrenContstructor) {
        super(parentAPI, zones, itemEntryPath);
        throw new Error(`${this} TODO itemEntryPath is removed.`);
