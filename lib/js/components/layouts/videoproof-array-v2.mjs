    ...
    constructor(widgetBus, _zones) {
        ...
        const widgets = [
          ...
          , [
              ...
              , ReactCounter
              , {
                  counterPath: `${this.widgetBus.rootPath.append('duration')}`
                }
              ]
          , [
                {zone: 'main'}
              ...
              , {
                  tPath: `${this.widgetBus.rootPath.append('t')}`
                , playingPath: `${this.widgetBus.rootPath.append('playing')}`
                , durationPath:`${this.widgetBus.rootPath.append('duration')}`
              }
            ]
