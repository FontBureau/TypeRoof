...
import {
    UIReactTimeControl
} from '../react-time-control/react-time-control.jsx';
...
} from '../react-counter.jsx';

import {
   UIReactTimeControl as UIReactTimeControlAlt
} from '../react-time-control-alternative.jsx';
...
class VideoproofArrayV2Controller extends _BaseContainerComponent {
    constructor(widgetBus, _zones) {
        ...
        const widgets = [
          ...
          , [
                {zone: 'main'}
              , [[ `${this.widgetBus.rootPath.append('duration')}`, 'counterPath']]
              , ReactRoot
              , ReactCounter
              ]
          , [
                {zone: 'main'}
              , [
                    [`${this.widgetBus.rootPath.append('t')}`, 'tPath']
                  , [`${this.widgetBus.rootPath.append('playing')}`, 'playingPath']
                  , [`${this.widgetBus.rootPath.append('duration')}`, 'durationPath']
                ]
              , ReactRoot
