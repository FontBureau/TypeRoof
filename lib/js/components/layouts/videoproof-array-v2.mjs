...
class UIAxesMathAxisTag extends _BaseComponent {
...
class _BaseUIAxesMap extends _BaseDynamicCollectionContainerComponent {
    ...
    constructor(widgetBus, _zones) {
        ...
        super(widgetBus, zones);
        Object.defineProperty(this, 'BASE_CLASS', {
            value: `${this.constructor.ROOT_CLASS}_${this.constructor.TYPE_CLASS_PART}`
        });

        localZoneElement.classList.add(this.constructor.ROOT_CLASS);
        localZoneElement.classList.add(this.BASE_CLASS);

        childrensMainZoneElement.classList.add(`${this.constructor.ROOT_CLASS}-items`);
        childrensMainZoneElement.classList.add(`${this.BASE_CLASS}-items`);
    ...
    _provisionWidgets() {
        ...
        for(const [index, [key, /*axesLocationSet*/]] of axesLocationMap.indexedEntries()) {
            // keys
            ...
            if(!keyProtocolHandler.hasRegistered(keyId)) {
                ...
                container.classList.add(`${this.constructor.ROOT_CLASS}-item`);
                container.classList.add(`${this.BASE_CLASS}-item`);
    ...
    _getWidgetSetup(rootPath) {
        ...
        switch (typeKey) {
            ...
            case 'LocationsProduct':
                ...
                dependencyMappings.push(['axesLocationSets', 'axesLocationMap']);
                args = [this._zones];
                break;
            case 'Location':
