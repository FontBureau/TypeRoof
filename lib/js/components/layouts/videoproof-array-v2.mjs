...
class UIAxesMathPlustListItems extends _BaseDynamicCollectionContainerComponent {
...
class UIAxesMathTimesListItems extends _BaseDynamicCollectionContainerComponent {
    constructor(widgetBus, zones, childrenSettings) {
          ...
          , function initAxesMath({axesMath}) {
            ...
            if(items.size === 0) {
                ...
                for(const axisTag of ['opsz', 'wdth', 'wght']) {
                    ...
                    {
                    //const location = createAxesMathItem('Location', items.dependencies)
                    const axisLocationValue = AxesMathAxisLocationModel.createPrimalDraft(location.dependencies)
                    axisLocationValue.get('logicalValue').value = 'number';
                    axisLocationValue.get('numericValue').value = {min:100, 'default':400, max:1000}[locationLogivalValueName];
