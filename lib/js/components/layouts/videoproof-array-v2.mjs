...
class _BaseUIMap extends _BaseDynamicCollectionContainerComponent {
    ...
    constructor(widgetBus, _zones, eventHandlers, label, dragAndDrop=false) {
        ...
        const orderStrategy = dragAndDrop
                  ...
                  // data order.
                ? _BaseUIMap.VISUAL_ORDER_STRATEGY_NATURAL
                : this.constructor.VISUAL_ORDER_STRATEGY || _BaseUIMap.VISUAL_ORDER_STRATEGY_NATURAL
                ;
        Object.defineProperties(this,{
                BASE_CLASS: {
                    value: `${this.constructor.ROOT_CLASS}_${this.constructor.TYPE_CLASS_PART}`
    ...
    _keyBlurHandler(index/*, event*/) {
        const inputWidget = this._keySlots[index].widgetWrapper.widget;
...
class UIAxesMathLocationsProduct extends _BaseUIAxesMap {
    ...
    static VISUAL_ORDER_STRATEGY = _BaseUIMap.VISUAL_ORDER_STRATEGY_NATURAL;
...
class UIAxesMathLocation extends _BaseUIAxesMap {
    ...
    static VISUAL_ORDER_STRATEGY = _BaseUIAxesMap.VISUAL_ORDER_STRATEGY_NATURAL;
