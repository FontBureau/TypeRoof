...
class UIParameterDisplay extends _BaseComponent {
    constructor(widgetBus, className) {
        super(widgetBus);
        this.element = this._domTool.createElement('div', {class: className});
        this._insertElement(this.element);
    }
    update(changedMap) {
...
class UIParametersDisplay extends _BaseDynamicCollectionContainerComponent {
    static REGISTERED_AXES_ORDERED = ['wght', 'wdth', 'opsz', 'ital', 'slnt', 'grad', 'GRAD'];
    ...
    _localUpdate(changedMap) {
        if(changedMap.has('animationProperties@')) {
            ...
            for(const axisTag of this.constructor.REGISTERED_AXES_ORDERED) {
            ...
            this._domTool.clear(this._parameters);
            const nodes = [];
            for(const [axisTag, value] of variations) {
                nodes.push(
                    this._domTool.createElement('strong', {}, axisTag)
                  , ': '
            ...
            this._parameters.append(...nodes);
            const colorPropertiesMap = [
                      [`${COLOR}stageBackgroundColor`, 'background-color']
                    // , [`${COLOR}textColor`, 'color']
                ]
              , getDefault = property => {
                    return [true, getRegisteredPropertySetup(property).default];
    ...
    _createWrapper(rootPath) {
        const settings = {
          ...
          , args = [this._zones, 'ui-parameters-display_layer', ...this._customArgs]
          , childWidgetBus = this._childrenWidgetBus
          ;
        return this._initWrapper(childWidgetBus, settings, dependencyMappings, Constructor, ...args);
    }
