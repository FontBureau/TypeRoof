...
class VideoproofArrayController extends _BaseContainerComponent {
    constructor(parentAPI, zones) {
        ...
        // old: const animationPropertiesKey = parentAPI.rootPath.append('videoproofArrayV2').toString()
        const animationPropertiesKey = `animationProperties@${parentAPI.rootPath.append('videoproofArrayV2')}`
        ...
        const widgets = [
          ...
          , [
                ...
                {
                    zone: 'main'
                  , rootPath: parentAPI.rootPath.append('videoproofArrayV2', 'keyMoments', '0', 'charGroup')
                }
              , []
              , UICharGroupContainer
              , zones
