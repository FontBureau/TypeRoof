    ...
    constructor(widgetBus, _zones, eventHandlers) {
        ...
        const widgets = [
            [
                ...
                , []
                , UIButton
                , new HTMLString('<span class="material-symbols-outlined">delete</span>')
          ...
          , [
                ...
                , []
                , UIButton
                , new HTMLString('<span class="material-symbols-outlined">swap_vert</span>')
                , [
    ...
    constructor(widgetBus, _zones, label) {
        ...
        const widgets = [
          ...
          , [
                ...
                , []
                , UIButton
                , new HTMLString('<span class="material-symbols-outlined">add</span>')
                , [['click', this._changeStateHandler((event)=>{
