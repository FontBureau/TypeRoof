...
// FIXME: AxesMathLocationsSumModel.items is AxesMathItemsModel which is _AbstractListModel
// it should therefore be possible to base this onto basics.mjs _UIBaseList
