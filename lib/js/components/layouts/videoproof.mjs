        ...
        const widgets = [
         ...
         , ...(()=>{
            const typeKey = 'VideoproofContextualActorModel'
              ...
              , contextualTypeDrivenFields = new Set(['presets', 'charGroups', 'template'])
              , isAllowedFieldName = name=>contextualTypeDrivenFields.has(name)
              , generalSettings = {
                    zone: 'main',
              ...
              , propertyRootOrPPSMap = GENERIC
              ;
            return this._defineGenericWidgets(
                    VideoproofContextualKeyMomentModel, //TypeClass,
                    isAllowedFieldName,
                    generalSettings,
