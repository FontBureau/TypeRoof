...
class TreeEditor extends _BaseComponent {
    ...
    _createItem(typeKey, dependencies) {
        ...
        return TypeSpec.createPrimalDraft(dependencies);
    }
    ...
    _isContainerItem(item) {
        ...
        return item instanceof TypeSpec;
    }
        ...
        const widgets = [
          ...
          , [
              ...
              , {
                    getDefaults: (...args)=>{
                        let result = null;
                        if(args[1].endsWith('Color'))
                            result = getRegisteredPropertySetup(`${COLOR}${args[1]}`).default;
                        console.log(`${this} injectable.getDefaults(`, ...args,`) =>`, result);
                        return result;
                    }
