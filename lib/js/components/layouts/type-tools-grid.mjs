    ...
    update (changedMap) {
        ...
        if(changedMap.has('@properties') || changedMap.has('showParameters')
            ...
            if(enhancedContrastColor)
                this.element.style.setProperty('--parametersLabelHighContrastTextColor', culoriFormatCss(enhancedContrastColor));
            else
                // unset, will fall-back to whatever CSS defines
                this.element.style.removeProperty('--parametersLabelHighContrastTextColor');
        }
    }
