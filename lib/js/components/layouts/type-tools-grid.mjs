...
} from './ramp/_BaseTypeSpecnion.typeroof.jsx';
import {
    axisLocationsGen
  , openTypeFeaturesGen
  , languageTagGen
} from './ramp/_getTypeSpecDefaultsMap.mjs';
import {
    TypeSpecLiveProperties
} from './ramp/TypeSpecLiveProperties.typeroof.jsx';
import {
    SyntheticValue
} from './ramp/SyntheticValue.mjs';
