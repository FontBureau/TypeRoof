    ...
    constructor(widgetBus, _zones) {
        ...
        const widgets = [
            ...
            ...this._availableDimemsions.map(dimensionKey=>{
                return [
                  ...
                  , { // injectable
                      ...
                      , getDefaults: typeToolsGridGetDefaults.bind(null, ()=>null)// getDefaults.bind(null, dimensionKey)
          ...
          , [
              ...
              , typeToolsGridGetDefaults.bind(null, ()=>null,  ProcessedPropertiesSystemMap.createSimpleRecord(GENERIC, 'fontSize'), 'fontSize', 66) //getDefaults.bind(null, 'fontSize', ProcessedPropertiesSystemMap.createSimpleRecord(GENERIC, 'fontSize'), 'fontSize', 66)
           ...
           , ... ['textColor', 'backgroundColor'].map(fieldName=>{
                    ...
                    return [
                      ...
                      , typeToolsGridGetDefaults.bind(null, ()=>null,  ppsRecord, fieldName)
                      , [] // updateDefaultsDependencies
          ...
          , [
              ...
              , UIManualAxesLocations
              , typeToolsGridGetDefaults.bind(null, ()=>null)// getDefaults.bind(null, 'axesLocations')
              , ProcessedPropertiesSystemMap.createSimpleRecord('axesLocations/', 'axesLocations')
              //, ()=>true//requireUpdateDefaults
            ]
          , [
                {
...
class TypeToolsGridController extends _BaseContainerComponent {
    constructor(widgetBus, _zones) {
        ...
        console.log('typeToolsGridDefaultsMap', typeToolsGridDefaultsMap);
        const widgets = [
