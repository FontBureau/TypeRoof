...
//      , [DIMENSION_Z, DimensionSequenceModel]
  ...
  , TypeToolsGridModel = _BaseLayoutModel.createClass(
      ...
      , ['document', NodeModel] // => todo merge with "content" eventually
      ...
      , CoherenceFunction.create(
        ...
        function initDocument({
            ...
            if (document.get("content").size === 0) {
                    const data = {
                        "typeKey": "doc",
                        "content": [
                            {
    ...
    update(changedMap) {
        ...
        if(changedMap.has('@properties') || changedMap.has('showCaptions')) {
            ...
            for(let y=0, l=dimensionY.sequence.length; y<l; y++) {
                ...
                for(let x=0, l=dimensionX.sequence.length; x<l; x++) {
                    ...
                    if(this._cellContents.hasRegistered(identifier)) {
                        ...
                        cell.append(this._domTool.createElement('div', {class:"old_content"}, this._cellContent));
            ...
            for(const [cell] of this._cellElements)
                cell.querySelector('old_content').textContent = this._cellContent;
        }
