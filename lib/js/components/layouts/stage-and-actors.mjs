...
class UIUpdateListener extends _BaseComponent {
...
export class UICharGroupContainer extends _BaseGenericKeyMomentWidgetsContainerComponent {
          ...
          , this._getWidgetConfig(injectable, generalSettings, propertyRoot, 'irrelevant'// 'generic/', 'charGroup',
              , [ UIUpdateListener
                ...
                , [ // require('settings:internalPropertyName', 'value')
                    ...
                    // the argument is not needed, but the dependencyMapping
                    // it injects, to trigger the update method.
    ...
    _onChange() {
        // figure out whether the extendedWidget is enabled or disabled
        ...
        // if there are no extendedChars disable
        // FIXME: extendedWidget.passive should do the right thing
        //        knowing the internal ._ui._uiInput structure is
        //        too tightly coupled.
        //        BUT also: the set expllicit button itself changes the
        //        passive of the ui and thus, it's a race condition thing.
        extendedWidget._ui._uiInput.passive = !data.extendedChars.length;
    }
