...
function genericTypeToUIElement(ModelType, defaultVal=_NOTDEF) {
    ...
    const valueUIElements = new Map([
          ...
          , [_AbstractEnumModel, [UISelectInput
                    , param('label'), param('items')]]
          , [CharGroupModel, [UISelectCharGroupInput
                    , CharGroupModel.charGroupsData, param('label')]]
        ])
      , valueOrEmptyUIElements = new Map([
            [StringModel, [UILineOfTextOrEmptyInput
                    , param('getDefault'), param('requireUpdateDefaults')
                    , param('label')]]
          , [_AbstractEnumModel, [UISelectOrEmptyInput
                    , param('getDefault'), param('requireUpdateDefaults')
                    , param('label'), param('items')]]
          , [CharGroupModel, [UISelectCharGroupOrEmptyInput
                    , param('getDefault'), param('requireUpdateDefaults')
                    , CharGroupModel.charGroupsData, param('label')]]
        ])
    ...
    if(!setupMap.has(SetupKey)) {
        ...
        const args = [ModelType.name, message, param('fullKey'), param('label')];
