...
class SelectAndDrag extends _BaseSelectAndDrag {
...
class StageManager extends _BaseComponent {
    // jshint ignore:start
    static TEMPLATE = `<fieldset class="stage-manager">
    <legend>Stage Manager</legend>
...
export class WasteBasketDropTarget extends _BaseComponent {
...
export class UICharGroupContainer extends _BaseGenericKeyMomentWidgetsContainerComponent {
    ...
    _onChange() {
        ...
        if(charGroup === 'custom') {
            ...
            const font = this.getEntry(this.widgetBus.rootPath.append('../../../font')).value;
