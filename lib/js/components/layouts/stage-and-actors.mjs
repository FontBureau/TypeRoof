...
const ColorTypeModel = _AbstractGenericModel.createClass('ColorTypeModel')// => .value will be a concrete _BaseColorModel
  ...
  , ColorModel = _AbstractStructModel.createClass(
    ...
    , PercentNumberModel = _AbstractNumberModel.createClass('PercentNumberModel', 0, 100)
    , PercentNumberOrEmptyModel = _AbstractSimpleOrEmptyModel.createClass(PercentNumberModel)
    , PercentWithNegativeNumberModel = _AbstractNumberModel.createClass('PercentWithNegativeNumberModel', -100, 100)
    ...
    , HueOrEmptyModel = _AbstractSimpleOrEmptyModel.createClass(NumberModel, 'HueOrEmptyModel')
