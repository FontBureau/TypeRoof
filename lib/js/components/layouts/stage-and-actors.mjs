...
function* genericPropertiesBroomWagonGen(outerAnimanionAPI, keyMoment/*, momentT*/) {
    for(const fieldName of keyMoment.keys()) {
        ...
        // FIXME: should use GENERIC there but there's another
        // call to _genericChildrenPropertiesBroomWagonGen which can't
        // obviously be taught the include the slash
...
export class UINumericProperties extends _BaseComponent {
    ...
    propertiesGet(key) {
        ...
        return getRegisteredPropertySetup(ppsRecord.fullKey)
    }
