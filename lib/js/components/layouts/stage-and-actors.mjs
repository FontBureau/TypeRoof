...
export class PlainColorComponentOrEmptyInput {
    ...
    update(componentKey, color, changeHandler, toggleHandler, defaultValue=0) {
...
class UIColorComponentRanges extends _BaseComponent {
    ...
    _updateComponent(i, componentKey, color, defaultValue) {
    ...
    update (changedMap) {
        ...
        if(changedMap.has('color') || requireUpdateDefaults) {
            ...
            for(const [i, componentKey] of enumerate(color.keys())) {
                ...
                this._updateComponent(i, componentKey, color, defaultValue);
            }
