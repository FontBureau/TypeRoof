...
class LayerDOMNode extends StaticNode {
    ...
    update(changedMap){
        ...
        if(changedMap.has('@animationProperties') || changedMap.has('globalT')) {
            ...
            // the example
            for(const property of ['numericProperties/x', 'numericProperties/y', 'numericProperties/z']) {
...
class CircleActorRenderer extends _BaseComponent {
    ...
    update(changedMap) {
        ...
        if(changedMap.has('@animationProperties') || changedMap.has('globalT')) {
            ...
            // should have a value!
            for(const property of ['numericProperties/r', 'numericProperties/x', 'numericProperties/y', 'numericProperties/z']){
                const value = propertyValuesMap.has(property)
                    ? propertyValuesMap.get(property)
                    : getDefault(property)
                    ;
...
const REGISTERED_NUMERIC_PROPERTIES = Object.freeze(new FreezableMap(Object.entries(
    {
      ...
      , z: {'default': 0, step: 1, inherit: false}
