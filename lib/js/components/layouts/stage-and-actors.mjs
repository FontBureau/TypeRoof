        ...
        const widgets = [
            [
              ...
              , function initAnimanion(keyMoments, isLoop) {
                    ...
                    console.warn(this.constructor.name, 'initAnimanion must have a parent animanion', this.parentAPI.rootPath.toString(), 'PARENT:', parent.parentAPI.rootPath.toString());
