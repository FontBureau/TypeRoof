...
const REGISTERED_PROPERTIES = Object.freeze(new FreezableMap(Object.entries(
    {
        x: {name: 'x', 'default': 0}
      , y: {name: 'y', 'default': 0}
      , r: {name: 'r', min: 0, 'default': 0}
      , t: {name: 't', 'default': 0}
    }
...
export class UINumericProperties extends _BaseComponent {
    ...
    propertiesHas(key) {
        return REGISTERED_PROPERTIES.has(key);
    }
    propertiesGet(key) {
    ...
    propertiesKeys() {
        return REGISTERED_PROPERTIES.keys();
    }
