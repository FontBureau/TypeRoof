...
export function initAnimanion(keyMoments, isLoop) {
    ...
    if(_keyMomentsImplementsTypography(keyMoments))
        // add typography
        propertyGenerators.push(fontSizeGen, axisLocationsGen, openTypeFeaturesGen);
    ...
    _renderLayer(path, activeActors, state=null) {
        ...
        for(const [key, actor] of activeActors) {
            const itemElement = this._domTool.createElement('li')
              ...
              , dragHandleElement = this._domTool.createElement('span', {'class': 'drag_handle'}, new HTMLString('<span class="material-symbols-outlined">drag_pan</span>'))
