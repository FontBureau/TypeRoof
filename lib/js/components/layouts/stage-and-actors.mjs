...
const ActorTypeModel = _AbstractGenericModel.createClass('ActorTypeModel')// => .value will be a concrete _BaseActorModel
  ...
  , StageAndActorsModel = _BaseLayoutModel.createClass(
      ...
      , ['activeActors', ActorReferencesModel]
        ...
        // for sure.
        // Other dependencies, however, should also be defined with a
        // type, so we can always be sure to receive the expected type.
        ...
        // Maybe that's also two things and a combination would be
        // StaticInternalizedDependency('availableActorTypes', AvailableActorTypesModel, availableActorTypes)
