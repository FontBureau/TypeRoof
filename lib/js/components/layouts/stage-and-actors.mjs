    ...
    update(changedMap){
        ...
        if(changedMap.has('@animationProperties') || changedMap.has('globalT')) {
            const animationProperties = changedMap.get('@animationProperties')
              , globalT = (changedMap.has('globalT') ? changedMap.get('globalT') : this.getEntry('globalT')).value
...
class CommonActorProperties extends _BaseComponent {
    ...
    update(changedMap) {
        if(changedMap.has('keyMoments')) {
            ...
            // NOTE it's implicit, but changedMap is expected to have
            // @animationProperties when keyMoments change
            const animationProperties = changedMap.get('@animationProperties')
        ...
        if(changedMap.has('@animationProperties') || changedMap.has('globalT')) {
            const globalT = (changedMap.has('globalT') ? changedMap.get('globalT') : this.getEntry('globalT')).value
