...
function initAnimanion(keyMoments, isLoop, parentProperties=null) {
        ...
        const localScopeAnimanion = new LocalScopeAnimanion(propertyGenerators, keyMoments, isLoop);
...
class CommonActorProperties extends _BaseComponent {
    ...
    update(changedMap) {
        ...
        if(changedMap.has('@animationProperties')) {
            const globalT = this.getEntry('globalT').value
              , animationProperties = changedMap.get('@animationProperties')
...
export class UINumericProperties extends _BaseComponent {
    static REGISTERED_PROPERTIES = ['x', 'y', 'r', 't']; //jshint ignore:line
