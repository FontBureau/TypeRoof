...
function initAnimanion(keyMoments, isLoop, parentProperties=null) {
    const numericAnimanion = new Animanion(
                parentProperties
    ...
    const fontSizeAnimanion = new Animanion(numericAnimanion, fontSizeGen, keyMoments, isLoop);
    return new Animanion(fontSizeAnimanion, axisLocationsGen, keyMoments, isLoop);
}
