...
`;
    ...
    async show(parentAPI, ...args) {
        console.log(`${this}.show args:`, ...args);
    ...
    async _createInchworm(parentApi, options, ...args) {
        console.log(`${this}._createInchworm options:`, options, parentApi, ...args);

        // create container
        // create line of text
        //     KeyFrame 0 has textContent "Inchworm"
        ...
        await parentApi.changeState(()=>{
            const activeActors = parentApi.getEntry(parentApi.rootPath.append('activeActors'))
              ...
              ;
            newMoment.get('label').value = '0: Init';
            ...
            numericProperties.setSimpleValue('y', 200);
            ...
            containerDraft.get('activeActors').push(lineOfTextActorDraft);
            activeActors.push(containerActorDraft);
        });
        console.log('After _changeState');
    }
}
...
class UISelectTaskAutomation extends _BaseComponent {
    ...
    async _executeItem(key) {
        ...
        console.log(`ENTER ${this}._executeItem ${key}`);
        console.log(`${this}._select`, this._select, `${this}._select.element.value`, this._select._input.value);
        let result = null;
        ...
        console.log(`RESULT ${this}._executeItem ${key}:`, result);
        return result;
    }
