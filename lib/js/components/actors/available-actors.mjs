...
export function getActorWidgetSetup({actor, typeKey, actorTypeModel, typeLabel
    ...
    if(typeClass === VideoproofArrayActorModel) {
        const KeyMomentModel = VideoproofArrayActorModel.fields.get('keyMoments').Model
          , charGroupModel = KeyMomentModel.fields.get('charGroup')
          , isOrEmpty = charGroupModel.prototype instanceof _AbstractSimpleOrEmptyModel
          , charGroupsData = (isOrEmpty
                                  ? charGroupModel.Model
                                  : charGroupModel).charGroupsData
          ;
        return [
            {
                rootPath: widgetRootPath
