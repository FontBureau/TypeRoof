...
function _getCellContents(charGroupsData, propertyValuesMap) {
    ...
    const cellContents = {changed: false, chars: [], stateKey: null};
...
export class VideoproofArrayActorRenderer extends _BaseComponent {
    ...
    update(changedMap) {
        ...
        //      // , getDefault = property => [true, _getRegisteredPropertySetup(property).default]
            ...
            const cellContents = _getCellContents(this._charGroupsData, propertyValuesMap)
