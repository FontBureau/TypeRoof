...
export class VideoproofArrayActorRenderer extends _BaseComponent {
    ...
    update(changedMap) {
        ...
        //      // , getDefault = property => [true, _getRegisteredPropertySetup(property).default]
            ...
            const cellContents = {changed: false, chars: []};
...
// TOODO: VideoproofArrayCellActorModel

export const [/*referencableActorTypes*/, videoproofArrayActorTypes] = initAvailableActorTypes([
    ['VideoproofArrayCellActorModel', 'Videoproof Array Cell', VideoproofArrayCellActorModel]
]);

export const VideoproofArrayActorV2Model = _BaseActorModel.createClass(
    'VideoproofArrayActorV2Model'
  , ...genericActorMixin
      // TODO: only stuff allowed in VideoproofArrayActorV2Renderer
      ...
      //       extandable, i.e. add another cell-level actor type...
...
/**
 * Starting from scratch for the moment.
 */
export class VideoproofArrayActorV2Renderer extends _BaseContainerComponent {
