...
export class VideoproofArrayV2ActorRenderer extends _BaseContainerComponent {
    ...
    _update(compareResult, requiresFullInitialUpdateSet, isInitialUpdate) {
        ...
        // NOTE: offsetWidth and offsetHeight are before css-transforms,
        // getBoundingClientRect is after.
        const {offsetWidth:width, offsetHeight:height} = this.widgetBus.wrapper.host
