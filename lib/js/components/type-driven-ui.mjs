...
import {
    UIOTFeaturesChooserCollapsible
...
import {
    UIHorizontalLayoutAlgorithm
  , UIColumnGutterAlgorithm
  , UIGrowColumns
} from "./type-spec/ui-horizontal-layout.typeroof.jsx";
...
export const uiElementsMap = new Map([
          ...
          , [LengthValueListModel, [UITypeDrivenListWithAddButton
                , require('settings:internalPropertyName', 'collection')
                , require('zones')
                , require('injectable')
                , require('propertyRoot')
                , require('label')
                , "+ add column" // addButtonText
                , null // UIItem=null
                , false // because we want to auto-sort; itemsDragable=true
                , true // itemsDeletable=false
            ]]
          , [GrowColumnsModel, [UIGrowColumns
          ...
          , [AxesLocationsModel, [UIManualAxesLocationsCollapsible
          ...
          , [HorizontalLayoutAlgorithmModel, [UIHorizontalLayoutAlgorithm
                , require('settings:rootPath')
                  // TODO: the component should be able to determine these
                  // by looking at its root type directly
                , require('settings:dependencyMapping', ['availableHorizontalLayoutAlgorithmTypes', 'availableTypes'])
                , require('settings:dependencyMapping', ['horizontalLayoutAlgorithmTypeKey', 'typeKey'])
                , require('zones')
                , require('injectable')
                , require('ppsRecord')]]
          , [ColumnGutterAlgorithmModel, [UIColumnGutterAlgorithm
                , require('settings:rootPath')
                  // TODO: the component should be able to determine these
                  // by looking at its root type directly
                , require('settings:dependencyMapping', ['availableColumnGutterAlgorithmTypes', 'availableTypes'])
                , require('settings:dependencyMapping', ['columnGutterAlgorithmTypeKey', 'typeKey'])
                , require('zones')
                , require('injectable')
                , require('ppsRecord')]]
          , [GutterPointModel, [UITypeDrivenContainer
                , require('settings:rootPath')
                , require('zones')
                , require('injectable')
                , require('ppsMap')
          ...
          , [OpenTypeFeaturesModel, [UIOTFeaturesChooserCollapsible
              //, require('settings:rootPath')
          ...
          , [LanguageTagModel, [UILanguageTagCollapsible
              , require('settings:rootPath')
              , require('zones')
          ...
          , [ManualBlockMarginsModel, [UIMarginsCollapsible
              , require('settings:rootPath')
              , require('zones')
              , require('label')
            ]]
          , [ManualInlineMarginsModel, [UIMarginsCollapsible
              , require('settings:rootPath')
              , require('zones')
              , require('label')
            ]]
          , [InlineLengthValueModel, [UIValueUnitPairInput
              , require('settings:rootPath')
              , require('zones')
              , require('label')
            ]]
          , [LengthModel, [UIValueUnitPairInput
              , require('settings:rootPath')
              , require('zones')
              , require('label')
            ]]
