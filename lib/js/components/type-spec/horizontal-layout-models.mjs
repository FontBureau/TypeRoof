...
export const ColumnCountModel = _AbstractNumberModel.createClass(
    ...
    GrowColumnsModeModel = _AbstractEnumModel.createClass(
        ...
        // Default: numeric growth by 1 — with an empty columns list
        // that's one column (consistent with fill), and the user's
        // first move is margin/padding control, not column spectacle.
        "number",
    ),
