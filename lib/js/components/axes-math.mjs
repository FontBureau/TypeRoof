    ...
    _createWrapperForType(typeKey) {
        ...
        switch (typeKey) {
            ...
            case 'Location':
                ...
                break;
            default:
                throw new Error(`UNKNOWN TYPE ${typeKey} in ${this}`);
        }
        return [
            settings
          , dependencyMappings
...
export class UIKeyMomentsLinkNavigation extends _BaseComponent {
...
<ol class="ui_key_moments_link_navigation-list"></ol>
    ...
    _clickHandler(event) {
        ...
        const key = this._inputToKey.get(event.target)
          ...
          ;
        this._setKeyMomentT(keyMomentT);
    }
    /**
     * Expects to be called within _changeState. Subclasses can override
     * this to navigate differently, e.g. the videoproof layout leaves its
     * "more axes" quick dial.
     */
    ...
    constructor(widgetBus, _zones, label, updateDefaultsDependencies, keyMomentsOptions=null) {
        const localZoneElement = widgetBus.domTool.createElement('div', {'class': 'ui_axes_math'})
          ...
          , _keyMomentsDefaultOptions = {zone: 'contents', label: 'Key Moments'
                , Widget: UIKeyMomentsLinkNavigation, dependencies: []}
        ...
        const widgets = [
          ...
          , [
              ...
              , [
                  ...
                  , ..._keyMomentsOptions.dependencies
                ]
              , _keyMomentsOptions.Widget
