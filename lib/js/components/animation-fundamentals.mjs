...
export * from './ui-time-control-circle.typeroof.jsx';
...
export function getBasicPlayerControlWidgets(options={zone:'main'}) {
    return {
        playing: [
          ...
          , UIToggleButton
          , 'playing'
          , new HTMLString('<span class="material-symbols-outlined">pause</span> pause')
          , new HTMLString('<span class="material-symbols-outlined">play_arrow</span> play')
      ...
      , perpetual: [
          ...
          , UIToggleButton
          , 'perpetual'
          , new HTMLString('<span class="material-symbols-outlined">refresh</span> is repeating')
          , new HTMLString('<span class="material-symbols-outlined">arrow_forward</span> is playing once')
