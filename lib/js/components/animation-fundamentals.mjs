...
export function getBasicPlayerControlWidgets(options={zone:'main'}) {
    return {
        playing: [
          ...
          , UIToggleButton
          , 'playing'
          , createIconAndLabel('pause', 'pause')
          , createIconAndLabel('play_arrow', 'play')
      ...
      , perpetual: [
          ...
          , UIToggleButton
          , 'perpetual'
          , createIconAndLabel('refresh', 'is repeating')
          , createIconAndLabel('arrow_forward', 'is playing once')
