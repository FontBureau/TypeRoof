...
class _UIInheritedStyleLinksListBase extends _BaseComponent {
    constructor(widgetBus, prefix, getSuffix) {
        super(widgetBus);
        this._prefix = prefix;
        this._getSuffix = getSuffix;
        this.element = widgetBus.domTool.createElement("ul", {
            class: "ui_links_map-inherited_list",
        });
...
class UIInheritedMarkStyleLinksList extends _UIInheritedStyleLinksListBase {
    constructor(widgetBus) {
        super(widgetBus, MARK_STYLE_LINKS, () => "");
    }
}
...
export class UIStylePatchesLinksContainer extends _BaseContainerComponent {
    constructor(widgetBus, zones) {
        super(widgetBus, zones);
        const typeSpecPath = widgetBus.rootPath,
            childrenOrderedMapPath = typeSpecPath
                .append("intentStyleLinks")
                .toString(),
            widgets = [
                [
                    { zone: "main" },
                    [
                        [childrenOrderedMapPath, "localStyleLinks"],
                        [
                            `typeSpecProperties@${typeSpecPath.toString()}`,
                            "typeSpecProperties@",
                        ],
                    ],
                ...
                [
                    { zone: "main" },
                    [
                        [childrenOrderedMapPath, "childrenOrderedMap"],
                        [
                            typeSpecPath
