...
class UIStylePatchLinksValue extends _BaseContainerComponent {
    constructor(widgetBus, _zones, optionGetLabel=null, optionsGen=null, hasTagInput=true) {
...
export class UIStylePatchesLinksMap extends _UIBaseMap {
    ...
    static VALUE_CONSTRUCTOR = null; // null: UIStylePatchLinksValue (class order)
    ...
    _createWrapperValue(keyId, key) {
        const childWidgetBus = this._childrenWidgetBus
          ...
          , Constructor = this.constructor.VALUE_CONSTRUCTOR ?? UIStylePatchLinksValue
          , args = [
...
class UIMarkStyleLinksValue extends UIStylePatchLinksValue {
    constructor(widgetBus, zones) {
        super(widgetBus, zones, null, null, false);
    }
}

class UIMarkStyleLinksMap extends UIStylePatchesLinksMap {
