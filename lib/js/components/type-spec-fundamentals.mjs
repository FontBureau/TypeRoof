...
export function deserializeLeadingAlgorithmModel(dependencies, data) {
    const serializeOptions = Object.assign({}, SERIALIZE_OPTIONS, {format: SERIALIZE_FORMAT_OBJECT})
    return deserializeSync(LeadingAlgorithmModel, dependencies, data, serializeOptions);
}
