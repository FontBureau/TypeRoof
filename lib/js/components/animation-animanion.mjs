...
// will probably be imported from somewhere
...
function getEasingFunction(keyMoment/*, propertyName*/) {
    ...
    // function isntructions. a catch-all for all axesLocations/ is
    // nice, maybe we can work with e.g. '*' wildcards.
    const easingFunction = keyMoment.get('easing', {value: identity}).value
    // if(propertyName.startsWith('axesLocations/'))
        // Immediately everything looks cooler! :-D
