...
export const LeadingNumberModel = _AbstractNumberModel.createClass('LeadingNumberModel', {defaultValue: 1.3/*, toFixedDigits: 5*/})
  ...
  , {
   ...
   , BlockMarginUnitModel = _AbstractEnumModel.createClass('MarginUnitModel', ['lineHeight', 'em', 'baseEm', 'pt', 'lineHeightAfter', 'emAfter'], 'lineHeight')
...
const typographyKeyMomentPureModelMixin = [
  ...
  , typographyInlineMixin = [
    ...
    // in EN
    // Rename LineLengthModel ...
  , LineLengthModel = _AbstractNumberModel.createClass('LineLengthModel', {min:0, /*max:160,*/ defaultValue: 40, toFixedDigits: 1})
  , LineLengthOrEmptyModel = _AbstractSimpleOrEmptyModel.createClass(LineLengthModel)
  , typographyParagraphMixin = [
    ...
    */
        ...
        ['lineLength', LineLengthOrEmptyModel] // default 39 EN  {min: 10, max: 160, step: 1, value: 40}
