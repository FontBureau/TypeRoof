...
export const LeadingNumberModel = _AbstractNumberModel.createClass('LeadingNumberModel', {defaultValue: 1.3/*, toFixedDigits: 5*/})
  ...
  , ManualBlockMarginsModel = _AbstractStructModel.createClass(
   ...
   , InlineLengthUnitOrEmptyModel = _AbstractSimpleOrEmptyModel.createClass(InlineLengthUnitModel)
...
const typographyKeyMomentPureModelMixin = [
  ...
  , ColumnCountModel =  _AbstractNumberModel.createClass('ColumnCountModel', {min:1, defaultValue: 1, toFixedDigits: 0})
  , ColumnCountOrEmptyModel = _AbstractSimpleOrEmptyModel.createClass(ColumnCountModel)
