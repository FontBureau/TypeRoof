...
export const LeadingNumberModel = _AbstractNumberModel.createClass('LeadingNumberModel', {defaultValue: 1.3/*, toFixedDigits: 5*/})
  ...
  , {
   ...
   , MarginUnitModel = _AbstractEnumModel.createClass('MarginUnitModel', ['lineHeight', 'em', 'baseEm', 'rem'], 'lineHeight')
  ...
  , ManualMarginsnModel = _AbstractStructModel.createClass(
        'ManualLeadingModel'
      , ['marginTop', MarginValueModel]
      , ['marginBottom', MarginValueModel]
    )
    ;
...
const typographyKeyMomentPureModelMixin = [
  ...
  , typographyParagraphMixin = [
    ...
    */
    ...
    //  , ['verticalMargins', ManualMarginsnModel]
