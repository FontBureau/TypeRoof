...
import { ClassesAndStylesManager } from "../components/classes-and-styles-manager.mjs";

import { EnvironmentProvider } from "../components/environment-provider.mjs";
...
export class MainUIController extends _BaseContainerComponent {
    ...
    constructor(widgetBus) {
        ...
        const [environmentProtocolName, environmentHandler] =
            SimpleProtocolHandler.create("environment@", {
                treatAdressAsRootPath: false,
            });
        widgetBus.protocolHandlers.set(
            environmentProtocolName,
            environmentHandler,
        );
