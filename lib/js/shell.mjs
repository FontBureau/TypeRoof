...
export class VideoproofController {
    ...
    async _allInitialResourcesLoaded(resources) {
        ...
        if(this._domTool.window.opener !== null) {
            const _handlePostMessage = async (event)=>{
                    ...
                    await this._fontManager._loadFontFromMessage(fontBuffer, metaData, 'replace');
                }
            ...
            this._domTool.window.opener.postMessage('init-live-fonts', '*');
        }
    }
