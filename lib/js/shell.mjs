...
export class VideoproofController {
    ...
    _initUI(/*{ ... remote resources }*/) {
        ...
        this._ui = new MainUIController({ // widgetBus
          ...
          , loadFontsFromUrls: this._useStateDependencyDraftContextWrapper(true
            ...
            // read values from it.
          // , useFont: this._useStateDependencyDraftContextWrapper(true
          //           , this._fontManager.useFont.bind(this._fontManager)
          //           , 'installedFonts')
          //   // This should not be needed anymore!
          // , unuseFont: this._useStateDependencyDraftContextWrapper(false
    ...
    async _asyncResolveFont(foreignKey, targetContainer, _requiredKey, defaultConstraint) {
        ...
        throw new Error(`RESOURCE ERROR ${this}._asyncResolve the font ${_requiredKey} is not available`);
