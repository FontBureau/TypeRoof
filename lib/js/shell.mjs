...
class FontManager {
    ...
    get _contentWindow() {
        return this._parentAPI.contentWindow;
    }

    get _requireStateDependencyDraft() {
        return this._parentAPI.requireStateDependencyDraft;
    }

    get _useStateDependency() {
        return this._parentAPI.useStateDependency;
    }

    get appReady() {
        return this._parentAPI.appReady;
    }
