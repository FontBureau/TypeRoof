...
export class VideoProofFont {
    ...
    get nameVersion() {
        return [
                 this._getName('fullName', 'fontFamily', 'postScriptName') // e.g. "RobotoFlex Regular"
    ...
    get serializationNameParticles() {
        ...
        return [this._getName('fullName', 'fontFamily', 'postScriptName'), this._getName('version')];
    }
